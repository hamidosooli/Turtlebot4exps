...
def main():
    ...
    Address = {1:[-0.1, .26], 2:[.85, .7], 3:[1.8, .7], 4:[.36, 1.2],
               5:[.6, 1.3], 6:[1.55, 1.4], 7:[.7, 2.3], 8:[.6, 3.05],
               9:[.6, 3.8], 10:[0.0, 4.5], 11:[.5, 4.5], 12:[1.45, 4.5],
...
# (1,3) --> 15 --> N
    ...
    goal_pose.append(navigator.getPoseStamped(Address[6], TurtleBot4Directions.SOUTH))
    goal_pose.append(navigator.getPoseStamped(Address[6], TurtleBot4Directions.SOUTH))
