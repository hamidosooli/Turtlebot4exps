...
def main(ros_domain_id_list=['1', '2', '3'], ros_namespace_list=['tb4_1', 'tb4_2', 'tb4_3']):
    ...
    Address = {'tb4_1':{1:[-0.1, .26], 2:[.85, .7], 3:[1.8, .7], 4:[.36, 1.2],
                        ...
                        9:[.7, 3.5], 10:[0.0, 4.5], 11:[.5, 4.5], 12:[1.45, 4.5],
                        13:[-0.2, 5.1], 14:[.6, 5.4], 15:[1.65, 5.3]},
               'tb4_2':{1:[-0.1, .26], 2:[.85, .7], 3:[1.8, .7], 4:[.36, 1.2],
                        5:[.6, 1.3], 6:[1.55, 1.4], 7:[.7, 2.3], 8:[.7, 3.05],
                        9:[.7, 3.8], 10:[0.0, 4.5], 11:[.6, 4.5], 12:[1.45, 4.5],
                        13:[-0.2, 5.1], 14:[.6, 5.3], 15:[1.55, 5.4]},
               'tb4_3':{1:[0.0, .5], 2:[.9, .6], 3:[1.8, .7], 4:[-0.1, 1.4],
                        5:[.9, 1.3], 55:[1., 1.3], 6:[1.55, 1.4], 7:[.9, 2.2], 8:[.7, 3.0],
                        9:[.8, 3.6], 10:[0.0, 4.4], 11:[.9, 4.7], 12:[1.45, 4.5],
    ...
    goal_pose['tb4_3'].append(navigator.getPoseStamped(Address['tb4_3'][10], TurtleBot4Directions.NORTH))
    goal_pose['tb4_3'].append(navigator.getPoseStamped(Address['tb4_3'][13], TurtleBot4Directions.EAST))
    goal_pose['tb4_3'].append(navigator.getPoseStamped(Address['tb4_3'][13], TurtleBot4Directions.EAST))
    goal_pose['tb4_3'].append(navigator.getPoseStamped(Address['tb4_3'][13], TurtleBot4Directions.EAST))
    goal_pose['tb4_3'].append(navigator.getPoseStamped(Address['tb4_3'][10], TurtleBot4Directions.NORTH))
    goal_pose['tb4_3'].append(navigator.getPoseStamped(Address['tb4_3'][10], TurtleBot4Directions.NORTH))
